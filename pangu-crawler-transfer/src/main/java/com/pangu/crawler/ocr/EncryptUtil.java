...
//    public static String key = "LmMGStGtOpF4xNyvYt54EQ==";
     ...
     * @return 加密后的字符串
     */
    public static String encrypt(String xmlStr,String secretKey) {
        byte[] encrypt = null;
     ...
     * @throws Exception
     */
    public static String decrypt(String xmlStr , String secretKey) throws Exception {
        // base64解码
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(Base64.encodeBase64String(encryptByPublicKey("91650000726988580W","MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCrgNNNXWSCfgVhL02pokkgjYp02OxUffBEjJUwg8targ0QpWwArTIMMfFio/yE9I1XD8iKgzDM1LLlPS2aeLROizQhHKK7z+B/6L2j3jOVpz8yIjoa2Ddk++RhyOekBqw58wws5RbXyXALvzgy54mkSQfG4WLfaISlcwXkRFNfNwIDAQAB")));
    }
